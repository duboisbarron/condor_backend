...
class TD_API:
    ...
    def get_call_debit_spreads(self, ticker, expiration):
        params = {
            'apikey': self.user_id,
            'symbol': ticker,
            'contractType': 'ALL'
        ...
        for index, long_strike in enumerate(good_keys):
            ...
            for short_strike in potential_short_strikes:
                ...
                try:
                    ...
                    valid_call_debit_spreads.append(calldebitObj)
    ...
    def get_put_credit_spreads(self, ticker, expiration):
        params = {
            'apikey': self.user_id,
            'symbol': ticker,
            'contractType': 'ALL'
        ...
        for index, short_strike in enumerate(good_keys):
            ...
            for long_strike in potential_long_strikes:
                ...
                try:
                    ...
                    valid_put_credit_spreads.append(calldebitObj)
        ...
        print(len(valid_put_credit_spreads))
        return valid_put_credit_spreads
...
if __name__ == '__main__':
    ...
    put_debit_spreads = td_api.get_put_credit_spreads('AAPL', expiration_date)
