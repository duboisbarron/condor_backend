...
class PutCredit:
    ...
    def get_max_gain(self):
        return round(100.0 * (self.short_put_prem - self.long_put_prem), 2)

    def get_max_loss(self):
        return round((100.0 * (self.short_put_strike - self.long_put_strike) - self.get_max_gain()), 2)
...
if __name__ == '__main__':
    ...
    put_debit = PutCredit(50, 45, 40, 3.0, 2.0, 1.1, 1.1)
